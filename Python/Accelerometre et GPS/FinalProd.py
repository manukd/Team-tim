...
def getDirection(latActuelle, longActuelle):
    r = requests.get('https://maps.googleapis.com/maps/api/directions/json?origin='+ latActuelle +',' + longActuelle +'&destination=Un Amour de Chien, 22 Ter Rue d\'Alsace, 21000 Dijon&key=AIzaSyC4DCIF0yx1PIDU-Mwv__iXSUKQ7hUYWCw')
    data = r.json()
